      ...
      <footer className="bg-white">
        <div className="max-w-7xl mx-auto px-4 py-8 md:px-8 md:py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <div className="space-y-4">
              <button className="w-full bg-primary text-primary-foreground py-2.5 px-4 rounded-lg font-semibold hover:bg-secondary transition-colors text-sm md:text-base">
                Cadastre seu imóvel
              </button>
        ...
        <div className="border-t border-gray-200">
          <div className="max-w-7xl mx-auto px-4 py-3 md:px-8 md:py-4">
            <div className="flex flex-col items-center">
              <div className="flex flex-col md:flex-row items-center gap-1 md:gap-3 text-xs md:text-sm">
                <span className="text-primary font-semibold">© Vitoria Imóveis.</span>
                <span className="text-gray-600">Todos os direitos reservados.</span>
                <Link href="#" className="text-gray-600 underline hover:text-primary transition-colors">
                  Termos de uso
                </Link>
              </div>
            </div>
